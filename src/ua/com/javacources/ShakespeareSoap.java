 ...
 * 
 */
@WebService(name = "ShakespeareSoap", targetNamespace = "http://xmlme.com/WebServices")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface ShakespeareSoap {
    ...
    @RequestWrapper(localName = "GetSpeech", targetNamespace = "http://xmlme.com/WebServices", className = "ua.com.javacources.GetSpeech")
    @ResponseWrapper(localName = "GetSpeechResponse", targetNamespace = "http://xmlme.com/WebServices", className = "ua.com.javacources.GetSpeechResponse")
